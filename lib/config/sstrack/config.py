...
"""
Add default config for SSTrack.
"""
cfg = edict()
...
# MUSTHSI 子集：仅训练/验证 list.txt 中列出的部分序列（二选一；若均未设则用全部）
cfg.DATA.TRAIN.MUSTHSI_SEQUENCE_NAMES = []  # 例如 ["BC-Bicycle-002"]
cfg.DATA.TRAIN.MUSTHSI_SEQ_IDS = []  # 或使用下标，例如 [0]
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["GOT10K_votval"]
cfg.DATA.VAL.DATASETS_RATIO = [1]
cfg.DATA.VAL.SAMPLE_PER_EPOCH = 10000
cfg.DATA.VAL.MUSTHSI_SEQUENCE_NAMES = []
cfg.DATA.VAL.MUSTHSI_SEQ_IDS = []
# DATA.SEARCH
